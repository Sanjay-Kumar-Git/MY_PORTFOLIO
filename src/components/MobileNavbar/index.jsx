...
useEffect(() => {
  ...
  return (
    <MobileNav $dark={dark} $isScrollingDown={isScrollingDown}>
      ...
      <NavItem onClick={onClickKnowMore} $dark={dark} $active={pathname === '/about'}>
        <FiUser />
        <span>About</span>
      </NavItem>

      <NavItem onClick={onClickProjects} $dark={dark} $active={pathname === '/projects'}>
        <FiGrid />
        <span>Projects</span>
      </NavItem>

      <NavItem onClick={onClickContact} $dark={dark} $active={pathname === '/contact'}>
        <FiSend />
        <span>Contact</span>
      </NavItem>
    </MobileNav>
